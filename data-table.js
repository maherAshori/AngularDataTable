...
dataTable.factory("dataTableScope", function () {
    var configs = {};

    configs.setMyConfig = function (settings) {
...
dataTable.directive("click", ["$compile", "dataTableScope", function ($compile, dataTableScope) {
    return {
        restrict: "A",
        scope: {
            click: "@",
